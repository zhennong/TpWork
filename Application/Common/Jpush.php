 ...
 */
class Jpush{
        private $app_key = '9b2d30c4487f01f68441f639';        //待发送的应用程序(appKey)，只能填一个。
        private $master_secret = '2de69e8199d13ca6822ea1c4';    //主密码
    ...
    /**
     * 极光推送主方法
     * @param $receive  消息推送目标用户
     * @param $content  推送内容
     * @param $m_type   推送字段类型（键）
     * @param $m_txt    推送字段扩展（值）
     * @param $m_time   消息保存时间
     */
